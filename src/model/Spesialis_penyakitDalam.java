 ...
 * @author USER
 */
public class Spesialis_penyakitDalam extends dokter implements Authentikasi {
    ...
    public Spesialis_penyakitDalam(int id, String nama_dokter, String spesialis, String noTelp, String email, String username, String password) {
        this.id = id;
