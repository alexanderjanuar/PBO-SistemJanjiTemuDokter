 ...
 * @author USER
 */
public class Spesialis_mata extends dokter implements Authentikasi {
    ...
    public Spesialis_mata(int id, String nama_dokter, String spesialis, String noTelp, String email, String username, String password) {
        this.id = id;
