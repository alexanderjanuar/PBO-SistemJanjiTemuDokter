 ...
 * @author USER
 */
public class Spesialis_umum extends dokter implements Authentikasi {
    ...
    public Spesialis_umum(int id, String nama_dokter, String spesialis, String noTelp, String email, String username, String password) {
        this.id = id;
