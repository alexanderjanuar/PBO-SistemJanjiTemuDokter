 ...
 * @author USER
 */
public class Spesialis_kandungan extends dokter implements Authentikasi {
    ...
    public Spesialis_kandungan(int id, String nama_dokter, String spesialis, String noTelp, String email, String username, String password) {
        this.id = id;
    ...
    public String getDatabaseName() {
        String url = "jdbc:mysql://localhost:3306/pa_pbo/dokter";
        return url;
    }
